...
export default function UnavailabilitySection() {
  ...
  return (
    <div className="mt-8">
      ...
      {/* Add form */}
      {adding && (
        <div className="bg-white rounded-lg border border-border p-5 mb-4 space-y-4">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg border border-border px-5 py-6 text-sm text-muted-foreground text-center">
